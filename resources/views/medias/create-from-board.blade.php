...
<form method="POST" enctype="multipart/form-data" action="{{ action('MediasController@storeFromBoard', [$comic->comic_id, $board->board_id]) }}" >
    @csrf
    ...
    <!-- <label for="media_filename">Titre du média :</label>
        ...
        <select id="media_type" name="dataType" required>
        ...
        <div class="contain-miniature">
            ...
            <input class="inputfile" type="file" id="media" name="media" required/>
